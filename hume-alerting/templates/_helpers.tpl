...
*/}}
{{- define "hume-alerting.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hume-alerting.fullname" .) .Values.serviceAccount.name }}
{{- else }}
